export const messages = {
  th: {
    ...
    foundation: "หน้านี้พร้อมใช้งาน", notFound: "ไม่พบหน้านี้", backHome: "กลับหน้าหลัก",
  },
  en: {
    ...
    foundation: "This page is ready", notFound: "Page not found", backHome: "Back to Home",
  },
};
...
Object.assign(messages.th, {
  ...
  noFeaturedProducts: "ยังไม่มีสินค้าแนะนำ", bannerTitle: "รับข่าวดีจาก pal2paw", bannerIntro: "ของใหม่ โปรลับ และเรื่องน่ารักส่งตรงถึงหน้าจอ", joinPack: "เข้าร่วมแก๊ง",
  ...
  loginTitle: "เข้าสู่ระบบ pal2paw", email: "อีเมล", signingIn: "กำลังเข้าสู่ระบบ",
...
Object.assign(messages.en, {
  ...
  noFeaturedProducts: "No featured products yet", bannerTitle: "Good news from pal2paw", bannerIntro: "New arrivals, secret deals, and cute stories delivered to your screen.", joinPack: "Join the Pack",
  ...
  loginTitle: "Sign in to pal2paw", email: "Email", signingIn: "Signing in",
...
Object.assign(messages.th, {
  manageProducts: "จัดการสินค้า", manageProductsIntro: "เพิ่ม แก้ไข และดูแลสต็อกสินค้าของ pal2paw", productInformation: "ข้อมูลสินค้า", productImage: "รูปสินค้า", imageHelp: "PNG, JPEG หรือ WebP ไม่เกิน 1.5 MB", productName: "ชื่อสินค้า", productDescription: "รายละเอียดสินค้า", productPrice: "ราคา (บาท)", stockQuantity: "จำนวนสต็อก", category: "หมวดหมู่", featuredProduct: "สินค้าแนะนำ",
  ...
  customerOrdersAdmin: "คำสั่งซื้อของลูกค้า", adminOrdersIntro: "ตรวจสอบคำสั่งซื้อและข้อมูลจัดส่งล่าสุด", loadingAdminOrders: "กำลังโหลดคำสั่งซื้อของลูกค้า", adminOrdersUnavailable: "ไม่สามารถโหลดคำสั่งซื้อได้", noAdminOrders: "ยังไม่มีคำสั่งซื้อจากลูกค้า", orderId: "เลขคำสั่งซื้อ", orderedAt: "วันที่สั่งซื้อ", customerDetails: "ข้อมูลลูกค้า", shippingAddress: "ที่อยู่จัดส่ง", orderItems: "รายการสินค้า", orderTotal: "ยอดรวม", orderStatus: "สถานะ", itemUnitPrice: "ราคาต่อชิ้น", itemSubtotal: "รวมรายการ", noOrderItems: "ไม่มีรายการสินค้า", shippingUnavailable: "ไม่มีข้อมูลจัดส่ง", snapshotUnavailable: "ไม่มีข้อมูล snapshot", paymentStatus: "สถานะการชำระเงิน", payNow: "ชำระเงิน", startingPayment: "กำลังเตรียมการชำระเงิน", paymentSuccess: "ชำระเงินสำเร็จ", paymentCancelled: "ยกเลิกการชำระเงิน", paymentVerificationPending: "ระบบกำลังยืนยันสถานะการชำระเงิน", paymentNotCompleted: "การชำระเงินยังไม่เสร็จสมบูรณ์", backToOrders: "กลับไปคำสั่งซื้อ",
});

Object.assign(messages.en, {
  manageProducts: "Manage Products", manageProductsIntro: "Add, edit, and maintain pal2paw product stock.", productInformation: "Product Information", productImage: "Product Image", imageHelp: "PNG, JPEG, or WebP up to 1.5 MB", productName: "Product Name", productDescription: "Product Description", productPrice: "Price (THB)", stockQuantity: "Stock Quantity", category: "Category", featuredProduct: "Featured product",
  ...
  customerOrdersAdmin: "Customer Orders", adminOrdersIntro: "Review the latest orders and shipping details.", loadingAdminOrders: "Loading customer orders", adminOrdersUnavailable: "Customer orders could not be loaded", noAdminOrders: "No customer orders yet", orderId: "Order ID", orderedAt: "Ordered at", customerDetails: "Customer snapshot", shippingAddress: "Shipping address", orderItems: "Items", orderTotal: "Total", orderStatus: "Status", itemUnitPrice: "Unit price", itemSubtotal: "Subtotal", noOrderItems: "No items", shippingUnavailable: "Shipping details unavailable", snapshotUnavailable: "Snapshot unavailable", paymentStatus: "Payment status", payNow: "Pay now", startingPayment: "Preparing payment", paymentSuccess: "Payment status", paymentCancelled: "Payment cancelled", paymentVerificationPending: "Your payment is being verified by the server.", paymentNotCompleted: "Payment was not completed.", backToOrders: "Back to orders",
});
...
Object.assign(messages.th, {
  ...
  adminDashboard: "แดชบอร์ดผู้ดูแล", adminFoundation: "จัดการสินค้าและคำสั่งซื้อของ pal2paw",
});
...
Object.assign(messages.en, {
  ...
  adminDashboard: "Admin Dashboard", adminFoundation: "Manage pal2paw products and customer orders.",
});
